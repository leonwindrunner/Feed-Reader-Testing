...
$(function() {
    ...
    describe('The menu', function() {
        ...
        beforeEach(function() {
            menu = $('body');
            menuHide = menu.hasClass('menu-hidden');
        });
        ...
        it('changes visibility when the menu icon is clicked', function() {
            ...
            menuIcon.click();
            menuHide = menu.hasClass('menu-hidden'); //get body's classname again
    ...
    describe('Initial Entries', function() {
        ...
        it('at least have a single .entry element within the .feed container when loadFeed function is called and completes its work', function() {
